-- Verify aoc-2023:day7-part2 on pg
...
DO $$
    ...
    BEGIN
        ...
        QQQJA 483
        ';
        expected_rankings := '[{"bet": 765, "hand": "32T3K", "rank": 1}, {"bet": 28, "hand": "KK677", "rank": 2}, {"bet": 684, "hand": "T55J5", "rank": 3}, {"bet": 483, "hand": "QQQJA", "rank": 4}, {"bet": 220, "hand": "KTJJT", "rank": 5}]';
        expected_score := 5905;
        -- When
        test_card_game_id := (
        ...
        rankings := (
            SELECT to_jsonb(
                array (SELECT bet, hand, overall_rank as rank
                       FROM trebuchet.card_hand_to_ranking(test_card_game_id)))
        );
        score := (
            SELECT sum(bet * rank)
